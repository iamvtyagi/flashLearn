    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const sortedUsers = response.data.sort((a, b) => b.quizzes.totalScore - a.quizzes.totalScore).slice(0, 2);
        ...
        <div className="max-w-7xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex justify-between items-center relative">
                    <div>
                        ...
                        <p className="text-[#2D3748] mt-2 text-lg">Ready to continue your learning journey?</p>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 transform hover:scale-[1.02] transition-all duration-300">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-xl font-semibold text-[#2D3748] mb-2">Learning Streak</h2>
                    ...
                    <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <p className="text-[#4285F4]">
                                {user.currentPlaylist.completed}/{user.currentPlaylist.total}
                            </p>
                        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link to="/leaderboard" className="text-[#4285F4] hover:text-[#4285F4]/80 font-medium flex items-center">
...
const ActivityPage = () => (
    <div className="max-w-7xl mx-auto p-8">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#4285F4] to-[#FF6D00] bg-clip-text text-transparent mb-6">Activity</h1>
...
const ClassesPage = () => (
    <div className="max-w-7xl mx-auto p-8">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#4285F4] to-[#FF6D00] bg-clip-text text-transparent mb-6">Classes</h1>
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
...
const FlashcardsPage = () => (
    <div className="max-w-7xl mx-auto p-8">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#4285F4] to-[#FF6D00] bg-clip-text text-transparent mb-6">Flashcards</h1>
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
