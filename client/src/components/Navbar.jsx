...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white shadow-lg fixed w-full top-0 z-50 border-b border-gray-100">
            <div className="max-w-[calc(100%-300px)] mx-6">
                {/*navbar spacing*/}
                    ...
                    <div className="flex items-center space-x-8 ml-8">
                        <Link
                            ...
                            className={`flex items-center space-x-2 ${isActive(
                                "/"
                            )} hover:text-[#4285F4] transition-all duration-200 font-medium`}
                        >
                        ...
                        <Link
                            ...
                            className={`flex items-center space-x-2 ${isActive(
                                "/classes"
                            )} hover:text-[#4285F4] transition-all duration-200 font-medium group`}
                        >
                            <FaBookOpen className="text-xl" />
                            <span>Classes</span>
                            <span className="ml-1 px-2 py-0.5 text-xs font-semibold bg-[#FF6D00] text-white rounded-full group-hover:bg-[#FF9A00] transition-colors duration-200">
                                New
                            </span>
                        </Link>
